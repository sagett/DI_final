...
//   id: [0,1,22,3,4,5]
// }
// console.log(message.id[2]);





// $('.smileyBtn').click(function() {
//   // find the id of this
//   // console.log(this);
//   var id = parseInt($(this).attr('id').substring(7, 8)); // id = smiley0
...
var isOn = [false,false,false,false,false,false];
...
$('.smileyBtn').click(function() {
  ...
  // manipulate audio src
  $('.player_audio').attr('src', 'music/' + soundtrack[id] + '.mp3');

  if (isOn[id] == false && playerIsOn == false){
    isOn[id] = true;
    playerIsOn = true;
    playSound();
    console.log("I'm being played");

  } else if (isOn[id] == false && playerIsOn == true) {

    isOn[id] = true;
    playerIsOn = true;
    playSound();

    } else if (isOn[id] == true && playerIsOn == true) {
    ...
    } else if (isOn[id] == true && playerIsOn == false) {
  ...
  for (var i = 0; i < isOn.length; i++) {
      console.log(i+" | " + isOn[i] + " | "+ playerIsOn +" | "+id);
  };
